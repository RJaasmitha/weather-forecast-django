...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\ODD SEM PFSD\pythonProject1\weather_forecast\venv\Jaasmitha'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\ODD SEM PFSD\pythonProject1\weather_forecast\venv\Jaasmitha\Scripts\deactivate.nu'
